	...
	<nav id="menu">
		...
		<table border="1" width="600px">
			...
			<div id="ex1" class="modal" rel="modal:open">
				<select id="del">
					<option value="#">잘못된 정보를 기제하였습니다.</option>
					<option value="#">이유1</option>
					<option value="#">이유2</option>
					<option value="#">이유3</option>
					기타 사유 : <br>
					<textarea type="text" placeholder="기타 사유를 입력하여 주세요."></textarea>
