...
<body>
	<div id="wrapper">
		<div id="main">
			...
			<div>
			연락처 : <input type="text"
				placeholder="승인여부를 안내 받으실 정확한 휴대전화 번호를  숫자로만 입력하여 주세요."></div><br>
				<div>
			개인 SNS 주소: <input type="text" palceholder="승인을 위한 간단한 확인 절차입니다."></div><br>
			<div>
			신청 이유(동기) :
			<textarea name="content" id="content" cols="80" rows="8"
				placeholder="신청 이유(동기)를 입력하여주세요."></textarea></div>
			<hr>
