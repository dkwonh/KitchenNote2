 ...
 * 
 * public void setPage() { if(page <= 0) { this.page = 1; } else { this.page =
 * page; } }
 * 
 * public int getPerPageNum() { return perPageNum; }
 * 
 * public void setPerPageNum(int pageCount) { int cnt = this.perPageNum;
 * if(pageCount != cnt) { this.perPageNum = cnt; } else { this.perPageNum =
 * pageCount; } } }
 */
