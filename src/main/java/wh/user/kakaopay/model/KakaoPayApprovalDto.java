...
public class KakaoPayApprovalDto {
	...
	public String toString() {
		return "KakaoPayApprovalDto [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", sid=" + sid
				...
				+ created_at + ", approved_at=" + approved_at + ", getAid()=" + getAid() + ", getTid()=" + getTid()
				+ ", getCid()=" + getCid() + ", getSid()=" + getSid() + ", getPartner_order_id()="
				+ getPartner_order_id() + ", getPartner_user_id()=" + getPartner_user_id()
				...
				+ getItem_code() + ", getPayload()=" + getPayload() + ", getQuantity()=" + getQuantity()
				+ ", getTax_free_amount()=" + getTax_free_amount() + ", getVat_amount()=" + getVat_amount()
				+ ", getCreated_at()=" + getCreated_at() + ", getApproved_at()=" + getApproved_at() + ", getClass()="
