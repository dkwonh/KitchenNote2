...
public class KakaoPayService {
	...
	public String kakaoPayReady(KakaoPayRequestDto req) {
        ...
        params.add("approval_url", "http://192.168.0.108:8080/KitchenNote2/kakaopay/kakaoPaySuccess.do");
        params.add("cancel_url", "http://192.168.0.108:8080/KitchenNote2/kakaopay/kakaoPayCancel.do");
        params.add("fail_url", "http://192.168.0.108:8080/KitchenNote2/kakaopay/kakaoPayFail.do");
